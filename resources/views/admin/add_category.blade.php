...
@section('page-title', 'Add New Category - SportFit')
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Winter Performance Wear" 
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" placeholder="Describe the sportswear..."
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary outline-none transition">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="icon" placeholder="fas fa-running" value="{{ old('icon') }}"
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <label for="thumbnail_input" class="relative group border-2 border-dashed border-gray-200 rounded-lg p-4 text-center hover:border-primary transition cursor-pointer block overflow-hidden">
                        ...
                        <img id="image_preview" class="hidden w-full h-32 object-cover rounded-lg">
                ...
                <button type="submit" class="w-full bg-primary hover:bg-primaryHover text-white font-bold py-3 rounded-xl shadow-lg transition transform hover:-translate-y-1">
