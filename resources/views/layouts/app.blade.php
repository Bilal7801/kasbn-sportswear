...
<head>
    ...
    <meta name="description" content="Premium sports goods manufacturer from Sialkot, Pakistan. Wholesale & bulk orders for leather footballs, gloves, boxing gear, and sportswear. ISO certified exporter.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .section-label {
            font-family: var(--font-cond); font-size: 11px; letter-spacing: 4px;
        ...
        .btn-outline {
            ...
            font-family: var(--font-cond); font-weight: 700; font-size: 14px;
            letter-spacing: 2px; text-transform: uppercase; padding: 13px 31px;
...
<body>
    ...
    <style>
        .whatsapp-float {
            ...
            text-decoration: none; box-shadow: 0 4px 20px rgba(37,211,102,0.4); transition: transform 0.2s;
        }
