...
.why-section {
    padding: 150px 0;
    background: #ffffff;                 /* pure white, matching right panel */
    position: relative;
    overflow: hidden;
}
...
.why-section::before {
    ...
    font-size: 140px;
    color: rgba(0,0,0,0.03);             /* black at 3% opacity */
    letter-spacing: 10px;
    pointer-events: none;
}
...
.why-section .section-title span {
    color: #000000 !important;           /* black, not gold */
}
.why-section .divider {
    background: #000000;                 /* black divider */
}
...
.why-feature {
    ...
    padding: 20px;
    background: #f3f4f6;                 /* light grey panel (input background) */
    border-left: 3px solid #000000;      /* black accent border */
...
.why-feature-icon {
    width: 44px;
    height: 44px;
    background: rgba(0,0,0,0.05);        /* black with low opacity */
    display: flex;
    align-items: center;
...
.export-flag {
    background: #e5e7eb;                 /* slightly darker grey */
...
.why-visual-card table td:last-child {
    font-family: var(--font-cond);
    font-weight: 700;
    color: #000000;                     /* black for quantities */
    text-align: right;
}
...
$features = [
    ...
    ['fa-globe','Worldwide Shipping','Delivered globally via sea, air or express courier. We handle all logistics and documentation.'],
    ...
    ['fa-clock','Fast Turnaround','3 to 5 days for samples. 15–30 day production for standard orders. Rush production available.'],
];
$countries = [
