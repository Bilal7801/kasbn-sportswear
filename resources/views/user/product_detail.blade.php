...
@section('content')
    ...
    @push('head')
        <meta name="description"
            content="{{ \Illuminate\Support\Str::limit(strip_tags($product->description ?? 'Premium sportswear designed for comfort, durability, and bulk customization.'), 155) }}">
        <meta name="keywords"
            ...
            <div class="product-detail-layout">
                    ...
                    @if ($product->images && $product->images->count() > 1)
                        <div class="gallery-thumbnails" id="thumbnailGallery">
                            @foreach ($product->images->take(4) as $index => $image)
                                <div class="gallery-thumb @if ($index === 0) active @endif"
                ...
                <div class="product-info">
                    ...
                    <div class="product-pricing">
                        ...
                        @if ($product->bulk_price)
                            <div class="price-block" style="text-align: right;">
                                ...
                                <span class="price-old" style="color: #ff6b35; text-decoration: none;">Per Unit
                                    (100+)</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="product-actions">
                        @php
    $enquiryUrl = route('enquiry.form', [
        'product_name' => $product->name,
        'product_slug' => $product->slug,
        'product_image' => $product->images && $product->images->count() > 0
    ...
    $loginUrl = route('login', [
        'redirect_to' => $enquiryUrl,
        'toast' => 'login_required'
    ]);
@endphp

@auth
    <a href="{{ $enquiryUrl }}" class="btn-enquiry" style="text-decoration:none;">
        <i class="fas fa-envelope"></i>
        Send Enquiry
    </a>
@else
    <a href="{{ $loginUrl }}" class="btn-enquiry" style="text-decoration:none;">
        <i class="fas fa-envelope"></i>
        Send Enquiry
    </a>
@endauth
                        ...
                        <a href="{{ route('product.show', $related->slug) }}" class="related-product-card">
                            ...
                            <div class="related-product-card-body">
                                ...
                                <div class="related-product-specs">
                                    ...
                                    <span class="related-product-spec"><i class="fas fa-check"></i> Custom
                                        Available</span>
                                </div>
                            </div>
                            ...
                            <div class="related-product-card-footer">
                                <div class="related-product-footer-pricing-row">
                                    <div>
                                        ...
                                        <div
                                            class="related-product-retail-price @if (!$related->bulk_price) no-strike @endif">
                                    ...
                                    @if ($related->bulk_price)
                                        <div style="text-align: right;">
                                            <div class="related-product-price-label" style="color: #ff6b35;">Bulk Pricing
                                            </div>
                                            <div class="related-product-bulk-price">
                                                ${{ number_format($related->bulk_price, 2) }}</div>
                                        </div>
                                    @endif
                                </div>
    ...
    <section class="page-enquiry" id="quick-enquiry">
        ...
        <div style="max-width: 1200px; margin: 0 auto; position: relative; z-index: 3;">
            <div class="enquiry-card">
                ...
                <p>Connect directly with our manufacturing division. Submit your design notes, material preferences, or
                    breakdown volumes below for optimized corporate B2B pricing.</p>
                ...
                <form method="POST" action="{{ route('enquiry.store') }}" class="premium-enquiry-form">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="volume" placeholder="Estimated Volume (e.g., 250+ units)"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="input-group full-width">
                        ...
                        <textarea name="specifications" id="specifications" rows="4"
                            placeholder="Detail your requirements (sizing, customization, color preferences, quantity, delivery timeline, etc.)..."></textarea>
                    </div>
            ...
            if (enquireBtn) {
                enquireBtn.addEventListener('click', function() {
                    ...
                    if (specsTextarea && productName) {
                        specsTextarea.value =
                            `Hi, I am looking for a production run quotation on the following product: "${productName}". Please provide packaging configurations, customization limits, and lead times.`;
                    }

                    document.querySelector('#quick-enquiry')?.scrollIntoView({
                        behavior: 'smooth'
                    });
                });
            }
